...
export type View = 'home' | 'member_access' | 'member_space' | 'register_introducer' | 'admin' | 'admin_individual' | 'admin_dashboard' | 'profile' | 'profiles_list' | 'formation_info' | 'presentation' | 'introducer_details' | 'training_lives' | 'membership_offer' | 'all_formations' | 'trust_us' | 'private_sale' | 'discover_formations' | 'website_presentation' | 'collaborate_creators';
